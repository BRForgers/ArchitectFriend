...
public class TrueColorClay extends Block implements ICraftable {
	...
	public TrueColorClay() {
		super(Material.rock);
		this.setBlockName("TrueColorClay");
		this.setBlockTextureName(Lib.TEXTURE_PATH + "Clay");
	...
	public Recipe[] getRecipes() {
		...
		r.add(new Recipe(
				new ItemStack(this,4,0), new String[]{"BHB","HCH","BHB"},
				new RecipeValue('C', new ItemStack(Items.clay_ball)), new RecipeValue('H', new ItemStack(Blocks.hardened_clay)), new RecipeValue('B', new ItemStack(Items.dye,1,15))
			)
		);
		
		r.add(new Recipe(
				new ItemStack(this,4,0), new String[]{"BHB","HCH","BHB"},
				new RecipeValue('C', new ItemStack(Items.clay_ball)), new RecipeValue('H', new ItemStack(Blocks.stained_hardened_clay,1,0)), new RecipeValue('B', new ItemStack(Items.dye,1,15))
			)
		);
